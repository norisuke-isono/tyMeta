...
{
    public class ScheduleIndexViewModel : IMapping
    {
        [Display(Name = "放送順")]
        ...
        {
            profile.CreateMap<Schedule, ScheduleIndexViewModel>()
                ...
                .ForMember(dest => dest.AirDate, opt => opt.MapFrom(src => src.Broadcast.AirDate))
