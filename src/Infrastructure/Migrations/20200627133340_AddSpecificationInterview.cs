...
{
    public partial class AddSpecificationInterview : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "SpecificationInterviews",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpecificationInterviews", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SpecificationInterviews_Specifications_SpecificationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SpecificationInterviews_SpecificationId",
                table: "SpecificationInterviews",
